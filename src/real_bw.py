...
import csv
import os
from algorithms.flow_info import CSV_FILE
INTERFACES = ['s1-eth1', 's1-eth3', 's3-eth2','s13-eth2','s7-eth1', 's7-eth2', 
              's5-eth1', 's6-eth2','s6-eth3', 's6-eth4','s6-eth5',
              's8-eth4','s8-eth5','s8-eth6','s9-eth3','s11-eth4',
              's2-eth3', 's4-eth5','s4-eth6','s4-eth7','s11-eth5','s12-eth3',]
