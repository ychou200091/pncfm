...
def MininetTopo():
    ...
    while True:
        ...
        '''if t==10:
            iperf_single( hosts=(h4,h2), udpBw='8M', period=90)
            print 'h4 h2'
        if t==25:
            iperf_single( hosts=(h3,h1), udpBw='7M', period=90)
            print 'h3 h1'
        if t==40:
            iperf_single( hosts=(h7,h8), udpBw='9M', period=120)
            print 'h7 h8'''
        if t==10:
            iperf_single( hosts=(h10,h8), udpBw='7M', period=90)
            print 'h4 h2'
        if t==25:
            iperf_single( hosts=(h1,h2), udpBw='5M', period=210)
            print 'h3 h1'
        '''if t==40:
            iperf_single( hosts=(h7,h8), udpBw='9M', period=120)
            print 'h7 h8'''
